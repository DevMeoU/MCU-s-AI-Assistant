...
#define WAKE_WORD_ENCODING_STACK_SIZE   (4 * 1024 * 7)
...
#define AUDIO_INPUT_PRIORITY            8
#define AUDIO_OUTPUT_PRIORITY           4
#define OPUS_CODEC_PRIORITY             2
...
#define WAKE_WORD_ENCODING_CORE         1
