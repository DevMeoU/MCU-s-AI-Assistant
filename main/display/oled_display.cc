...
void OledDisplay::SetupUI_128x64() {
    ...
    // Create left fixed-width container
    content_left_ = lv_obj_create(content_);
    lv_obj_set_size(content_left_, 32, LV_SIZE_CONTENT);  // Fixed width 32 pixels
    ...
    // Create right expandable container
    ...
    // Start scrolling marquee after a delay
    static lv_anim_t a;
    lv_anim_init(&a);
