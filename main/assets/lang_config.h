...
namespace Lang {
    ...
    namespace Strings {
        ...
        constexpr const char* HELLO_MY_FRIEND = "Xin chào người đẹp đáng yêu nhất vũ trụ nha!";
    ...
    namespace Sounds {
        ...
        extern const char ogg_alarm_start[] asm("_binary_alarm_ogg_start");
        extern const char ogg_alarm_end[] asm("_binary_alarm_ogg_end");
        static const std::string_view OGG_ALARM {
        static_cast<const char*>(ogg_alarm_start),
        static_cast<size_t>(ogg_alarm_end - ogg_alarm_start)
        };
