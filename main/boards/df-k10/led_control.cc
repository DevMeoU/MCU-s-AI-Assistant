...
LedStripControl::LedStripControl(CircularStrip* led_strip) 
    ...
    // Đọc cấp độ độ sáng từ cài đặt
    Settings settings("led_strip");
    brightness_level_ = settings.GetInt("brightness", 4);  // Cấp độ mặc định 4
