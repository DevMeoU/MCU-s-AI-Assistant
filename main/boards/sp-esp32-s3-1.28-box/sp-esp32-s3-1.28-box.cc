...
public:
    CustomLcdDisplay(esp_lcd_panel_io_handle_t io_handle,
        ...
        // Do màn hình là tròn, thanh trạng thái cần tăng khoảng cách bên trái và phải
...
private:
    ...
    void InitializePowerSaveTimer() {
        ...
        power_save_timer_->OnShutdownRequest([this]() {
            ...
            // Kích hoạt chức năng giữ để đảm bảo mức điện áp ổn định trong khi ngủ
    ...
    static void touchpad_timer_callback(void* arg) {
        ...
        const int64_t TOUCH_THRESHOLD_MS = 500;  // Ngưỡng thời gian chạm, trên 500ms được coi là nhấn giữ
