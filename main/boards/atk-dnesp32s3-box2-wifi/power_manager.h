...
private:
    ...
    void CheckBatteryStatus() {
        ...
        // Nếu dữ liệu mức pin không đủ, thì đọc dữ liệu mức pin
    ...
    void ReadBatteryAdcData() {
        ...
        const struct {
            ...
            {2696, 0},      /*  3.48V - Màn hình nhấp nháy */
            {2724, 20},     /*  3.53V */
            {2861, 40},     /*  3.7V */
            {3038, 60},     /*  3.90V */
            {3150, 80},     /*  4.02V */
        ...
        // Khi cao hơn giá trị tối đa
            ...
            // Tính toán giá trị trung gian bằng nội suy tuyến tính
            for (int i = 0; i < 5; i++) {
...
public:
    ...
    bool IsCharging() {
        // Nếu pin đã đầy, thì không hiển thị đang sạc nữa
    ...
    bool IsDischarging() {
        // Không phân biệt giữa sạc và xả, nên trực tiếp trả về trạng thái ngược lại
        return !is_charging_;
    }
