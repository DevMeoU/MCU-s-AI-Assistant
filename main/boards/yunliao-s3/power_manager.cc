...
void PowerManager::Initialize(){
    ...
    // Cấu hình chân giám sát mức pin
    ...
    // Tạo hàng đợi sự kiện GPIO mức pin
    gpio_evt_queue = xQueueCreate(2, sizeof(uint32_t));
    // Cài đặt dịch vụ ISR GPIO mức pin
