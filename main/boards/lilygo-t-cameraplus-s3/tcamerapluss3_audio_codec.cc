...
Tcamerapluss3AudioCodec::Tcamerapluss3AudioCodec(int input_sample_rate, int output_sample_rate,
    ...
    input_reference_ = input_reference;         // Whether to use reference input to achieve echo cancellation
...
int Tcamerapluss3AudioCodec::Read(int16_t *dest, int samples) {
    if (input_enabled_) {
        ...
        // Amplify microphone received volume by 20 times (limited within int16_t range to prevent overflow)
        int16_t *ptr = dest;
