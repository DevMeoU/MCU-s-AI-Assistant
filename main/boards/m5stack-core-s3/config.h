...
#define CAMERA_PIN_XCLK  GPIO_NUM_NC // Pixel clock (fixed input from 20MHz external crystal oscillator) 
#define CAMERA_PIN_SIOD GPIO_NUM_NC  // Serial data Using existing I2C port
