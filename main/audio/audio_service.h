...
#define MAX_ENCODE_TASKS_IN_QUEUE 8  // Increased from 4 to 8 for better buffering
#define MAX_PLAYBACK_TASKS_IN_QUEUE 8  // Increased from 4 to 8 for better buffering
#define MAX_DECODE_PACKETS_IN_QUEUE (2400 / OPUS_FRAME_DURATION_MS)
#define MAX_SEND_PACKETS_IN_QUEUE (2400 / OPUS_FRAME_DURATION_MS)
#define AUDIO_TESTING_MAX_DURATION_MS 10000
#define MAX_TIMESTAMPS_IN_QUEUE 5
