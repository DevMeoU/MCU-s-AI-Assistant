...
BoxAudioCodec::BoxAudioCodec(void* i2c_master_handle, int input_sample_rate, int output_sample_rate,
    ...
    duplex_ = true; // Có phải là duplex
    input_reference_ = input_reference; // Có sử dụng đầu vào tham chiếu, thực hiện loại bỏ tiếng vang
    input_channels_ = input_reference_ ? 2 : 1; // Số lượng kênh đầu vào
